    ...
    `;
      ...
      return (
            <div className="relative pointer-events-none">
                  ...
                  <div id="glass" className="fixed bottom-0 left-1/2 -translate-x-1/2 rounded-t-2xl w-[90%] min-[550px]:w-[93.5%] h-[20vh] min-[550px]:h-[15dvh] overflow-hidden  shadow-lg shadow-black/25 inset-shadow-black/15 z-[9999]" />
