      ...
      return (
            <section className="w-full py-5 pr-7   flex justify-between  items-center  sm:px-20 ">
                  ...
                  <div className="overflow-hidden flex px-5  sm:px-0 items-center text-center w-[90%]  sm:w-full  pb-1">
                        <svg className="scale-50 sm:scale-75 " width="70" height="58" viewBox="0 0 70 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex-11/12">
                              <h1 className="sm:text-2xl md:text-3xl lg:text-4xl text-[1.5rem]  hidden min-[500px]:text-[1.3rem]  min-[500px]:block  sm:block  font-Astralaga selection:bg-[#3D5557]/60  text-[#3D5557]  sm:leading-none  font-semibold uppercase">way to explore more !</h1>
                              ...
                              <p className="text-xl  sm:block hidden font-Nova selection:bg-[#3D5557]/60 capitalize opacity-85 tracking-normal leading-none  font-medium text-center">Over 6M+ Curated Photos</p>
                        </div>
                  </div>
