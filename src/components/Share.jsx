...
const Share = () => {
      ...
      return (
            <StyledWrapper>
                  <div onClick={handleShare} className="centralize">
                        <div>
                              <button>
                                    <span className="ml-10">
                                          <svg width={12} height={12} fill="white" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 467 512.22">
                                                <path
                                                      fillRule="nonzero"
